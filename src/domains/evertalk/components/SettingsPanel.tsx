...
const EXTERNAL_PROVIDER_PRESETS: ExternalProviderPreset[] = [
    ...
    },
    {
        ...
        baseUrl: buildVertexBaseUrl(VERTEX_PROJECT_PLACEHOLDER, VERTEX_DEFAULT_LOCATION),
        apiKeyHint: 'gcloud auth print-access-token',
        models: [
